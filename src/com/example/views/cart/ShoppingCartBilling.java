...
public class ShoppingCartBilling extends LinearLayout implements OnClickListener, OnEventControlListener{
	Button btnBack, btnNext;
	TextView txtTitleHeader;
	Context mContext;
	public EditText contactEmail;
	OnEventControlListener mlistener;
	public ShoppingCartBilling(Context context, OnEventControlListener listener) {
		super(context);
		mContext = context;
		mlistener = listener;
		LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		inflater.inflate(R.layout.shopping_cart_billing, this, true);
		...
		txtTitleHeader.setText(mContext.getString(R.string.billing));
	}
	...
	public void onClick(View view) {
		...
		{
			mlistener.onEvent(ActionEventConstantShoppingCart.ACTION_CHANGE_VIEW_SHIPPING, null, null);
		}
	}
